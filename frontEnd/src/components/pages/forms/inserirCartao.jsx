...
export default class inserirCartao extends Component {
    constructor(props) {
        ...
        this.handleChangeCardNum = this.handleChangeCardNum.bind(this);
        this.handleChangeDataVal = this.handleChangeDataVal.bind(this);
    ...
    render() {
        const sesh = localStorage.getItem('userData');
        
        const {numeroCartao, cvv, dataVal, bandeira, clienteId} = this.state;
                                ...
                                <div className="w-full flex flex-row w-full">
                                    <div className="flex flex-col w-6/12">
                                        ...
                                        <input
                                            ...
                                            onChange={this.handleChangeCardNum}
                                        />
                                    </div>
